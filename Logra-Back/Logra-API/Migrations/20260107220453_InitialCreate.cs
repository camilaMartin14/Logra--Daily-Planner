        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MorningNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WaterIntake = table.Column<int>(type: "int", nullable: true),
                    ...
                    Snack = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskCategories_Tasks_TaskItemId",
